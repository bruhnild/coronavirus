...
\COPY sante.opencovid19fr(date_actualisation, granularite, maille_code, maille_nom, confirmes, deces, deces_ehpad, reanimation, hospitalises, gueris, depistes, source_nom, source_url, source_archive, source_type) FROM '/home/mfu/Documents/Projets/coronavirus/jupyter_notebook_coronavirus/data/sources_traitees/opencovid19fr.csv' DELIMITER ',' CSV HEADER ENCODING 'utf8' NULL '';
...
\COPY sante.donneeshospitalierescovid19(dep, sexe, jour,hosp,rea,rad,dc) FROM '/home/mfu/Documents/Projets/coronavirus/jupyter_notebook_coronavirus/data/sources_traitees/donnees-hospitalieres-covid19.csv'DELIMITER ';' CSV HEADER ENCODING 'utf8' NULL '';
