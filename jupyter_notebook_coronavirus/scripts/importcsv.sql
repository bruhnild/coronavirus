...
--- Schema : sante
--- Table : sursaud_covid19_quotidien
--- Traitement : Intégration csv opencovid19 france en base
TRUNCATE TABLE sante.sursaud_covid19_quotidien;

\COPY sante.sursaud_covid19_quotidien(code_dep, date_actualisation, sursaud_cl_age_corona,nbre_pass_corona,nbre_pass_tot,nbre_hospit_corona,nbre_pass_corona_h, nbre_pass_corona_f, nbre_pass_tot_h,nbre_pass_tot_f,nbre_hospit_corona_h,nbre_hospit_corona_f,nbre_acte_corona,nbre_acte_tot,nbre_acte_corona_h,nbre_acte_corona_f,nbre_acte_tot_h,nbre_acte_tot_f) FROM '/home/mfu/Documents/Projets/coronavirus/jupyter_notebook_coronavirus/data/sources_traitees/sursaud-covid19-quotidien.csv'DELIMITER ',' CSV HEADER ENCODING 'utf8' NULL '';
